...
<body>
    <div id="container" class="!h-[400px]">
       ...
       <div style="background-color: rgb(245, 246, 247);" id="navbar" class="fixed top-[-15px] w-[90%] z-40  px-2">
        ...
        <div class="rounded-[30px] flex justify-center items-center mt-[250px]" id="first-picture">
            ...
            <h1 style="font-family: 'Poetsen One', sans-serif;" class="absolute text-white text-8xl ">Livraison</h1>
        </div>
    </div>
    ...
    <section class="max-w-4xl mx-auto px-4 py-12">
        <pre style="font-family: 'Poetsen One', sans-serif;" class="text-2xl flex justify-center text-center">❝   Chez Shiny, notre priorité est de vous offrir une expérience de livraison rapide, <br>  fiable et adaptée à vos besoins.   ❞</pre>

        <div class="space-y-8 mt-15">

            <div>
                <h2 class="text-2xl font-semibold mb-4">Modes de Livraison Disponibles</h2>
                <p><strong>Livraison Standard à Domicile</strong> : Frais de livraison à partir de <strong>20 MAD</strong>. Livraison sous <strong>24h à 6 jours ouvrables</strong>.
                </p>
                <p class="mt-2"><strong>Livraison Gratuite</strong> : Offerte pour toute commande supérieure à <strong>590 MAD</strong>.</p>
            </div>

            <div>
                <h2 class="text-2xl font-semibold mb-4">Processus de Livraison</h2>
                <ul class="list-disc pl-6 space-y-2">
                    <li>Confirmation de commande par appel téléphonique.</li>
                    <li>Suivi disponible dans votre compte Shiny, rubrique « Mes commandes ».</li>
                </ul>
            </div>

            <div>
                <h2 class="text-2xl font-semibold mb-4">Délais et Conditions</h2>
                <p>Livraisons du <strong>lundi au vendredi</strong>, hors jours fériés.</p>
                <p class="mt-2">Les délais peuvent être légèrement prolongés durant les périodes de forte activité.</p>
            </div>

            <div>
                <h2 class="text-2xl font-semibold mb-4">Absence lors de la Livraison</h2>
                <p>En cas d'absence, le transporteur vous contactera pour une nouvelle tentative ou un retrait en point relais.</p>
            </div>

            <div>
                <h2 class="text-2xl font-semibold mb-4">Modification d'Adresse</h2>
                <p>Adresse modifiable tant que la commande n'est pas "emballée". Sinon, il faudra annuler et repasser la commande.</p>
            </div>

            <div>
                <h2 class="text-2xl font-semibold mb-4">Réception d'un Article Défectueux</h2>
                <p>Contactez notre service client en cas de réception d'un produit endommagé ou incorrect. Nous vous apporterons une solution rapide.</p>
            </div>

            <div>
                <h2 class="text-2xl font-semibold mb-4">Informations Supplémentaires</h2>
                <ul class="list-disc pl-6 space-y-2">
                    <li>Shiny n'est pas responsable des retards dus aux transporteurs, mais nous vous assistons en cas de problème.</li>
                    <li>En cas de rupture de stock, nous vous contacterons pour un remboursement ou une solution alternative.</li>
                </ul>
            </div>

        </div>

        <p class="mt-12 text-center text-gray-700">Merci pour votre confiance ! Pour toute question, veuillez consulter notre contacter notre service client.</p>
    </section>
