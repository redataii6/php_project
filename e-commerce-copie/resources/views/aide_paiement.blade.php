...
<body>
    <div id="container" class="!h-[400px]">
        ...
        <div class="rounded-[30px] flex justify-center items-center mt-[250px]" id="first-picture">
            ...
            <h1 style="font-family: 'Poetsen One', sans-serif;" class="absolute text-white text-8xl ">Paiement</h1>
        </div>
    </div>
    ...
    <section class="max-w-4xl mx-auto p-6">
        <pre style="font-family: 'Poetsen One', sans-serif;" class="text-2xl mb-15 text-center">❝   Régler vos achats chez Shiny n'a jamais été aussi simple et sécurisé.   ❞</pre>

        <div class="space-y-10">
            <div>
                <h2 class="text-2xl font-semibold mb-4">Quels moyens de paiement puis-je utiliser sur Shiny ?</h2>
                <p class="mb-2">Nous proposons plusieurs moyens de paiement pour ta commande :</p>
                <ul class="list-disc list-inside ml-4 space-y-3">
                    <li><strong>Paiement par carte bancaire via PayPal</strong> : Tu peux régler ta commande en toute sécurité avec ta carte bancaire (Visa, MasterCard) via PayPal, sans avoir besoin de créer un compte PayPal. Dès que tu choisis cette méthode, tu seras redirigé vers la page sécurisée de PayPal où tu pourras entrer tes informations de carte et finaliser ton paiement. Le tout, sans aucun frais supplémentaire pour toi.</li>
                    <li><strong>Paiement à la livraison</strong> : Si tu préfères payer à la réception de ta commande, tu peux choisir l'option <span class="italic">paiement à la livraison</span>. Cette méthode te permet de régler tes achats directement au moment où tu reçois ton colis, en espèces. Cette option est disponible uniquement pour les livraisons à domicile dans les zones couvertes par notre service.</li>
                </ul>
                <p class="mt-2">Que tu préfères payer en ligne ou directement à la réception de ta commande, Shiny te laisse le choix.</p>
            </div>

            <div>
                <h2 class="text-2xl font-semibold mb-4">Quand mon compte sera-t-il débité ?</h2>
                <p class="mb-2">Sur Shiny, ton compte bancaire sera <strong>débité immédiatement</strong> après la validation de ton paiement.</p>
                <p class="mb-2">Dès que ton paiement est autorisé par ta banque, nous lançons directement la préparation et l'emballage de ta commande.</p>
                <p>Si, pour une raison exceptionnelle, nous rencontrons un problème lors du traitement de ta commande après validation, notre service client te contactera pour trouver une solution rapide.</p>
            </div>

            <div>
                <h2 class="text-2xl font-semibold mb-4">Pourquoi mon paiement par carte peut-il être refusé ?</h2>
                <ul class="list-disc list-inside ml-4 mb-2">
                    <li>Carte expirée : vérifie la date d'expiration de ta carte.</li>
                    <li>Plafond atteint : assure-toi que tu n'as pas dépassé la limite de ta carte.</li>
                    <li>Erreur de saisie : vérifie que toutes les informations sont correctes.</li>
                </ul>
                <p>Si tout est correct mais que le paiement échoue, contacte ta banque.</p>
            </div>

            <div>
                <h2 class="text-2xl font-semibold mb-4">Les paiements sont-ils sécurisés sur Shiny ?</h2>
                <p class="mb-2">Absolument. Toutes les transactions sont protégées par le protocole <strong>SSL (Secure Socket Layer)</strong>. Tes données sont chiffrées et confidentielles.</p>
                <p class="mb-2">Le <strong>code CVV</strong> est demandé pour plus de sécurité et n'est jamais enregistré sur notre site.</p>
                <p>Nous utilisons aussi des systèmes anti-fraude pour protéger toutes les transactions.</p>
            </div>
            
            
            <p class="text-gray-700 text-center">En cas de problème avec ton paiement, notre équipe pourra te contacter pour t'accompagner et garantir la sécurité de ta commande.</p>
        </div>
    </section>
