        ...
        <div class="w-[20%] bg-white rounded-[20px] p-4 h-[300px]">
            ...
            <div class="p-6">
                <a href="{{ route('mon.compte') }}">
                    <p class="font-semibold text-lg text-gray-600">Mon Compte</p>
                </a>
                <a href="{{ route('commandes.index') }}" class="mt-2">
                    <p class="underline decoration-2 font-semibold text-lg mt-2">Mes Commandes</p>
                </a>
            </div>

        </div>

        <div class="bg-white rounded-[20px] p-8 ml-10 w-[100%]">
            <div class="relative overflow-hidden bg-white shadow-md rounded-lg mb-40">
                    ...
                    <table class="w-full text-sm text-left text-gray-500">
                        ...
                        <tbody>
                            <tr class="border-b" onclick="toggleItems({{ $commande->id }})">
                                ...
                                <td class="px-4 py-2 font-medium text-gray-900">{{ $commande->created_at->format('d M Y') }}</td>
                                ...
                                <td onclick="event.stopPropagation()">
                                    <form action="{{ route('factureClient.pdf', $commande->id) }}" method="POST">
                                        @csrf
                            ...
                            <tr class="border-b hidden" id="items-{{ $commande->id }}">
                                <td colspan="8" class="px-4 py-2 text-black w-full">
                                    <div class="grid grid-cols-3 space-y-5 w-full">
                                        ...
                                        <div class="flex w-full">
                                            ...
                                            <div class="">
                                                ...
                                                <div class="flex">
                                                    <span class="text-sm text-gray-600 font-semibold !ml-3 mt-2">Couleur : </span>
