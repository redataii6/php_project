...
<body>
    <div id="container" class="!h-[350px]">
        ...
        <div class="rounded-[30px] flex justify-center items-center mt-[250px]" id="first-picture">
            ...
            <h1 style="font-family: 'Poetsen One', sans-serif;" class="absolute text-white text-8xl ">Politique de Confidentialité</h1>
        </div>
    </div>


    <div class="max-w-6xl mx-auto p-6 text-gray-800">

        <h2 class="text-2xl font-semibold mt-6 mb-2">1. Qui sommes-nous ?</h2>
        <p class="ml-30">Nous sommes <strong>Shiny</strong>, une marque de commerce électronique basée au <strong>Maroc</strong>. La protection de vos données personnelles est une priorité pour nous. Cette politique de confidentialité vise à vous informer de manière claire sur la manière dont nous collectons, utilisons, partageons et protégeons vos informations.</p>

        <h2 class="text-2xl font-semibold mt-10 mb-2">2. Quelles données collectons-nous ?</h2>
        <p class="ml-30">Nous collectons vos données personnelles lorsque :</p>
        <ul class="list-disc list-inside ml-40">
            <li>Vous créez un compte client</li>
            <li>Vous passez une commande</li>
            <li>Vous nous contactez via le formulaire de contact ou par email</li>
            <li>Vous utilisez notre site internet</li>
        </ul>
        <p class="ml-30">Les données collectées peuvent inclure : nom, prénom, adresse e-mail, adresse de livraison, numéro de téléphone, informations de paiement, historique de commandes.</p>

        <h2 class="text-2xl font-semibold mt-10 mb-2">3. Pourquoi utilisons-nous vos données ?</h2>
        <p class="ml-30">Nous utilisons vos données pour :</p>
        <ul class="list-disc list-inside ml-40">
            <li>Gérer votre compte client</li>
            <li>Traiter et livrer vos commandes</li>
            <li>Vous informer sur l’état de votre commande</li>
            <li>Répondre à vos demandes ou messages</li>
            <li>Améliorer nos services et votre expérience sur le site</li>
            <li>Respecter nos obligations légales</li>
        </ul>

        <h2 class="text-2xl font-semibold mt-10 mb-2">4. Base légale du traitement</h2>
        <p class="ml-30">Nous traitons vos données principalement sur la base :</p>
        <ul class="list-disc list-inside ml-40">
            <li>De votre <strong>consentement</strong></li>
            <li>De l’<strong>exécution d’un contrat</strong></li>
            <li>D’<strong>obligations légales</strong></li>
            <li>De notre <strong>intérêt légitime</strong></li>
        </ul>

        <h2 class="text-2xl font-semibold mt-10 mb-2">5. Avec qui partageons-nous vos données ?</h2>
        <p class="ml-30">Vos données peuvent être partagées avec :</p>
        <ul class="list-disc list-inside ml-40">
            <li>Nos prestataires techniques</li>
            <li>Nos partenaires de paiement </li>
            <li>Les transporteurs ou services de livraison</li>
            <li>Les autorités si la loi l'exige</li>
        </ul>
        <p class="ml-30"><strong>Nous ne vendons jamais vos données à des tiers.</strong></p>

        <h2 class="text-2xl font-semibold mt-10 mb-2">6. Durée de conservation</h2>
        <p class="ml-30">Vos données sont conservées pendant le temps nécessaire aux finalités décrites ci-dessus, ou aussi longtemps que la loi l'exige.</p>

        <h2 class="text-2xl font-semibold mt-10 mb-2">7. Vos droits</h2>
        <p class="ml-30">Conformément à la législation marocaine, vous disposez des droits suivants :</p>
        <ul class="list-disc list-inside ml-40">
            <li>Droit d'accès</li>
        ...
        <h2 class="text-2xl font-semibold mt-10 mb-2">8. Sécurité de vos données</h2>
        <p class="ml-30">Nous mettons en place toutes les mesures nécessaires pour garantir la sécurité de vos informations personnelles et prévenir tout accès non autorisé ou toute fuite.</p>

        <h2 class="text-2xl font-semibold mt-10 mb-2">9. Cookies</h2>
        <p class="ml-30">Nous utilisons des cookies pour améliorer votre navigation. Vous pouvez modifier vos préférences dans les paramètres de votre navigateur.</p>

        <h2 class="text-2xl font-semibold mt-10 mb-2">10. Modifications</h2>
        <p class="ml-30">Cette politique peut être mise à jour à tout moment. Toute modification sera publiée sur cette page.</p>
        <p class="mt-4"><strong>Dernière mise à jour :</strong> 21 avril 2025</p>
    </div>
